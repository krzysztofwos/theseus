...
| 5 | Explain a subsystem end to end, citing files | Investigation over `read`/`search`/`list` | — | — |
| 6 | Author a capability from local evidence gathered by `search`+`read`, not only `show` | Reading before writing | — | — |
